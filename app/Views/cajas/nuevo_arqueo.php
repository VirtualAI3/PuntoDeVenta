                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            ...
                            <input type="text" class="form-control" id="monto_inicial" name="monto_inicial" value="<?php echo set_value('monto_inicial'); ?>" required>
                        </div>
                        <div class="col-12 col-sm-6">
                            <label for="">Folio inicial</label>
                            <input type="text" class="form-control" id="folio" name="folio" value="<?php echo set_value('folio',$caja['folio']); ?>" required>
                        </div>
